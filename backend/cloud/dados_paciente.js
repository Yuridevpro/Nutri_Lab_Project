...
Parse.Cloud.define("criarDadosPaciente", async (request) => {
  ...
  try {
    ...
    return {
      success: true,
      message: "Dados do paciente criados com sucesso!",
      dadosPaciente: result,
    };
  } catch (error) {
...
Parse.Cloud.define("buscarDadosPaciente", async (request) => {
  ...
  try {
    ...
    return {
      success: false,
      message:
        "Dados do paciente não encontrados ou não autorizado: " + error.message,
    };
  }
});
...
Parse.Cloud.define("atualizarDadosPaciente", async (request) => {
  ...
  try {
    ...
    return {
      success: false,
      message:
        "Erro ao atualizar dados do paciente ou não autorizado: " +
        error.message,
    };
  }
});
...
Parse.Cloud.define("deletarDadosPaciente", async (request) => {
  ...
  try {
    ...
    return {
      success: true,
      message: "Dados do paciente deletados com sucesso!",
    };
  } catch (error) {
    ...
    return {
      success: false,
      message:
        "Erro ao deletar dados do paciente ou não autorizado: " + error.message,
    };
  }
});
