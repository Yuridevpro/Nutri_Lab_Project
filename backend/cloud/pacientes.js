...
Parse.Cloud.define("buscarPaciente", async (request) => {
  ...
  try {
    ...
    throw new Error(
      "Paciente não encontrado ou não autorizado: " + error.message,
    );
  }
});
...
Parse.Cloud.define("atualizarPaciente", async (request) => {
  ...
  try {
    ...
    throw new Error(
      "Erro ao atualizar paciente ou não autorizado: " + error.message,
    );
  }
});
...
Parse.Cloud.define("deletarPaciente", async (request) => {
  ...
  try {
    ...
    throw new Error(
      "Erro ao deletar paciente ou não autorizado: " + error.message,
    );
  }
});
// Fim alan
